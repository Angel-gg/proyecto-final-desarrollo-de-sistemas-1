new_seed_logic = """
    ...
    {
        new() { Nombre="NVIDIA RTX 5080 Ti", Tipo="Tarjetas de Video", Marca="NVIDIA", Descripcion="GPU de última generación con 24 GB GDDR7, ray tracing y DLSS 4.0 para gaming 4K extremo.", Especificaciones="24 GB GDDR7 · PCIe 5.0 · 450W TDP · DLSS 4.0 · Ray Tracing Gen 4", Precio=19500.00m, Stock=15, ImageUrl="https://images.unsplash.com/photo-1587202372634-32705e3bf49c?w=600&q=80&auto=format&fit=crop" },
        new() { Nombre="Intel Core Ultra 9 285K", Tipo="Procesadores", Marca="Intel", Descripcion="Procesador de 24 núcleos (8P+16E) a 5.7 GHz boost, socket LGA1851.", Especificaciones="24 núcleos · 5.7 GHz boost · LGA1851 · DDR5-6400 · 125W TDP", Precio=6500.00m, Stock=28, ImageUrl="https://images.unsplash.com/photo-1591799264318-7e6ef8ddb7ea?w=600&q=80&auto=format&fit=crop" },
        new() { Nombre="Samsung 990 Pro 2TB NVMe", Tipo="Almacenamiento", Marca="Samsung", Descripcion="SSD PCIe 5.0 con velocidades de lectura hasta 14,800 MB/s. Ideal para workstations.", Especificaciones="2 TB · PCIe 5.0 · 14,800 MB/s lectura · M.2 2280", Precio=1600.00m, Stock=52, ImageUrl="https://images.unsplash.com/photo-1544986581-efac024faf62?w=600&q=80&auto=format&fit=crop" },
        new() { Nombre="ASUS ROG Maximus Z890 Hero", Tipo="Tarjetas Madre", Marca="ASUS", Descripcion="Tarjeta madre ATX LGA1851, DDR5 hasta 8000 MHz OC, 5x M.2 PCIe 5.0, Wi-Fi 7.", Especificaciones="LGA1851 · DDR5-8000 OC · 5x M.2 · Wi-Fi 7 · Thunderbolt 4", Precio=4500.00m, Stock=10, ImageUrl="https://images.unsplash.com/photo-1518770660439-4636190af475?w=600&q=80&auto=format&fit=crop" },
        new() { Nombre="G.SKILL Trident Z5 RGB 64GB DDR5", Tipo="Memoria RAM", Marca="G.Skill", Descripcion="Kit de memoria DDR5-6400 CL32, 2x32 GB, con iluminación RGB y XMP 3.0.", Especificaciones="64 GB (2x32) · DDR5-6400 · CL32 · XMP 3.0 · ARGB", Precio=2400.00m, Stock=34, ImageUrl="https://images.unsplash.com/photo-1562408590-e32931084e23?w=600&q=80&auto=format&fit=crop" },
        new() { Nombre="Corsair HX1500i Platinum", Tipo="Fuentes de Poder", Marca="Corsair", Descripcion="Fuente modular 1500W 80+ Platinum con iCUE, protección completa y cableado sleeved.", Especificaciones="1500W · 80+ Platinum · Full Modular · ATX 3.0 · PCIe 5.0", Precio=2500.00m, Stock=20, ImageUrl="https://images.unsplash.com/photo-1617791160536-598cf32026fb?w=600&q=80&auto=format&fit=crop" },
        new() { Nombre="LG UltraGear 27GS95QE OLED 240Hz", Tipo="Monitores", Marca="LG", Descripcion="Monitor OLED QHD 27\\\" a 240Hz con 0.03ms GTG, HDR True Black 400, HDMI 2.1.", Especificaciones="27\\\" OLED QHD · 240Hz · 0.03ms · HDR True Black 400 · HDMI 2.1", Precio=8500.00m, Stock=8, ImageUrl="https://images.unsplash.com/photo-1527443224154-c4a3942d3acf?w=600&q=80&auto=format&fit=crop" },
        new() { Nombre="Logitech G Pro X Superlight 2", Tipo="Periféricos", Marca="Logitech", Descripcion="Mouse gaming inalámbrico 32,000 DPI, 60h de batería, 60g con sensor HERO 2.", Especificaciones="32,000 DPI · 60h batería · 60g · USB-C · LIGHTSPEED", Precio=1200.00m, Stock=45, ImageUrl="https://images.unsplash.com/photo-1527864550417-7fd91fc51a46?w=600&q=80&auto=format&fit=crop" },
        new() { Nombre="Cooler Master MasterLiquid 360 ATMOS", Tipo="Refrigeración", Marca="Cooler Master", Descripcion="Refrigeración líquida AIO 360mm, 3x ventiladores ARGB 120mm, soporte LGA1851 y AM5.", Especificaciones="360mm AIO · 3x120mm ARGB · LGA1851 / AM5 · 2800 RPM", Precio=1800.00m, Stock=22, ImageUrl="https://images.unsplash.com/photo-1563396983906-b3795482a59a?w=600&q=80&auto=format&fit=crop" },
        new() { Nombre="Razer BlackWidow V4 Pro", Tipo="Periféricos", Marca="Razer", Descripcion="Teclado mecánico inalámbrico, switches Razer Yellow, Chroma RGB y dial multimedia.", Especificaciones="Razer Yellow · Wireless · Chroma RGB · Dial multimedia · Macro", Precio=1500.00m, Stock=30, ImageUrl="https://images.unsplash.com/photo-1541140532154-b024d705b90a?w=600&q=80&auto=format&fit=crop" },
        
        // Nuevos Productos AMD y Accesorios
        new() { Nombre="AMD Ryzen 9 9950X", Tipo="Procesadores", Marca="AMD", Descripcion="16 núcleos y 32 hilos con arquitectura Zen 5, socket AM5, PCIe 5.0.", Especificaciones="16 núcleos · 5.7 GHz boost · AM5 · 170W TDP", Precio=6200.00m, Stock=15, ImageUrl="https://images.unsplash.com/photo-1591799264318-7e6ef8ddb7ea?w=600&q=80&auto=format&fit=crop" },
        new() { Nombre="ASUS ROG Crosshair X670E Hero", Tipo="Tarjetas Madre", Marca="ASUS", Descripcion="Placa madre entusiasta AM5 para Ryzen serie 7000/9000, 2x PCIe 5.0 x16, Wi-Fi 6E.", Especificaciones="AM5 · X670E · DDR5-6400+ · Wi-Fi 6E · Dual USB4", Precio=4200.00m, Stock=12, ImageUrl="https://images.unsplash.com/photo-1518770660439-4636190af475?w=600&q=80&auto=format&fit=crop" },
        new() { Nombre="AMD Radeon RX 7900 XTX", Tipo="Tarjetas de Video", Marca="AMD", Descripcion="GPU tope de gama RDNA 3, 24GB GDDR6, DisplayPort 2.1, ideal para 4K.", Especificaciones="24 GB GDDR6 · RDNA 3 · DP 2.1 · 355W TDP", Precio=9800.00m, Stock=8, ImageUrl="https://images.unsplash.com/photo-1587202372634-32705e3bf49c?w=600&q=80&auto=format&fit=crop" },
        new() { Nombre="Corsair MP700 PRO 2TB Gen5", Tipo="Almacenamiento", Marca="Corsair", Descripcion="SSD NVMe M.2 PCIe Gen5 x4 con enfriador activo, velocidades hasta 12,400 MB/s.", Especificaciones="2 TB · PCIe 5.0 · 12,400 MB/s · Activo", Precio=2100.00m, Stock=25, ImageUrl="https://images.unsplash.com/photo-1544986581-efac024faf62?w=600&q=80&auto=format&fit=crop" },
        new() { Nombre="Lian Li O11 Dynamic EVO", Tipo="Cases", Marca="Lian Li", Descripcion="Chasis Mid-Tower ATX de doble cámara, paneles de cristal templado reversibles.", Especificaciones="ATX Mid-Tower · Cristal Templado · Dual Chamber", Precio=1450.00m, Stock=18, ImageUrl="https://images.unsplash.com/photo-1517059224940-d4af9eec41b7?w=600&q=80&auto=format&fit=crop" }
    };
    ...
    if (gpu != null && cpu != null && ram != null && ssd != null && mb != null && psu != null && cool != null)
    {
        combos.Add(new EcommerceApp.Models.Combo {
            ...
            PrecioVenta = 36800.00m, Stock = 5, Activo = true, ImageUrl = "https://images.unsplash.com/photo-1593640495253-23196b27a87f?w=600&q=80&auto=format&fit=crop",
    ...
    if (mon != null && mouse != null && kb != null)
    {
        combos.Add(new EcommerceApp.Models.Combo {
            ...
            PrecioVenta = 10500.00m, Stock = 12, Activo = true, ImageUrl = "https://images.unsplash.com/photo-1612287230202-1ff1d85d1bdf?w=600&q=80&auto=format&fit=crop",
            ComboComponentes = new List<EcommerceApp.Models.ComboComponente> {
    ...
    if (cpu != null && mb != null && ram != null && ssd != null)
    {
        combos.Add(new EcommerceApp.Models.Combo {
            ...
            PrecioVenta = 14250.00m, Stock = 8, Activo = true, ImageUrl = "https://images.unsplash.com/photo-1547082299-de196ea013d6?w=600&q=80&auto=format&fit=crop",
            ComboComponentes = new List<EcommerceApp.Models.ComboComponente> {
...
with open(r'c:\Users\soya7\Downloads\tarea en clase 2\EcommerceApp\Program.cs', 'r', encoding='utf-8') as f:
    lines = f.readlines()

new_lines = lines[:133] + [new_seed_logic + "\n"] + lines[299:]

with open(r'c:\Users\soya7\Downloads\tarea en clase 2\EcommerceApp\Program.cs', 'w', encoding='utf-8') as f:
    f.writelines(new_lines)

print("Replaced lines 134 to 299 directly by line index.")
